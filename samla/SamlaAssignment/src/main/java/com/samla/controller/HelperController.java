...
public class HelperController {
	...
	@PostMapping("/next")
	public ResponseEntity<ValidateResponse> next(@RequestBody AnswerDTO answerdto){
		return new ResponseEntity<ValidateResponse>(gs.validate(answerdto),HttpStatus.OK);
	}
